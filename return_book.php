...
<nav class="navbar navbar-expand-lg navbar-light "style=" background-color:gray">
  ...
  <a class="navbar-brand" href="admin_dashboard.php">Dashboard</a>
              ...
              <form action="" method="post">
               ...
               <div class="form-group">
                ...
                <div class="form-group">
                    ...
                    <input type="text"name="return_date"class="form-control" value="<?php echo date("y-m-d");?>" 
                    required="">
                </div>
                <button type="sumbit" class="btn btn-primary"name="return_book">Return Book</button>
              </form>
            </div>
    ...
    if(isset($_POST['return_book']))
    {
        $connection = mysqli_connect("localhost","root","");
        $db = mysqli_select_db($connection,"lms");
        $query = "insert into returned_books.php values(null,$_POST[book_no],'$_POST[book_name]','$_POST[book_author]',$_POST[student_id],1,'$_POST[issue_date]')";
        $query_run = mysqli_query($connection,$query);
