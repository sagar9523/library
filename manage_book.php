    ...
    <table class="table table-bordered table-hover" style="text-align:center">
      <thead>
          ...
          <?php
            ...
            <td> <button class="btn"name=""><a href="edit_books.php?bn=<?php echo $row['book_no'];?>">Edit</a></button>
            <button class="btn"name=""><a href="delete_books.php?bn=<?php echo $row['book_no'];?>">Delete</a></button></td>
            </tr>
            <?php
            }
            ?>
