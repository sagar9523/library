...
$query = "select  returned_books.book_name,returned_books.book_author,returned_books.book_no,users.name from returned_books left join users on issued_books.student_id=users.id";
?>
...
<nav class="navbar navbar-expand-lg navbar-light "style=" background-color:gray">
  ...
  <a class="navbar-brand" href="admin_dashboard.php">Dashboard</a>
    ...
    <div class="row">
        ...
        <div class="col-md-8">
            <form>
                <table class="table-bordered"width="900px" style="text-align: center;background-color:White;">
                    <tr>
                        <th>Name:</th>
                        <th>Author:</th>
                        <th>Number:</th>
